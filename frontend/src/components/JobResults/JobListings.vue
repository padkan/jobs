    ...
    ...mapState(useJobsStore, {
      ...
      nextPage() {
        ...
        const lastPage = Math.ceil(
          this.FILTER_JOBS_BY_ORGANISATIONS.length / 10
        );
      ...
      displayedJobs() {
        ...
        return this.FILTER_JOBS_BY_ORGANISATIONS.slice(
          firstJobIndex,
          lastJobIndex
        );
      }
...
mapActions,, FILTER_JOBS_BY_ORGANISATIONS
